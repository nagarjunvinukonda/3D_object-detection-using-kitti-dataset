...
batch_size = 32
network = FrustumPointNet("Frustum-PointNet_eval_val", project_dir="/home/vrushabhdesai07/3DOD_thesis")
network.load_state_dict(torch.load("/home/vrushabhdesai07/3DOD_thesis/training_logs/model_Frustum-PointNet_1/checkpoints/model_Frustum-PointNet_1_epoch_100.pth"))
network = network.cuda()

NH = network.BboxNet_network.NH

val_dataset = EvalDatasetFrustumPointNet(kitti_data_path="/home/vrushabhdesai07/3DOD_thesis/data/kitti",
                                         kitti_meta_path="/home/vrushabhdesai07/3DOD_thesis/data/kitti/meta",
                                         type="val", NH=NH)
