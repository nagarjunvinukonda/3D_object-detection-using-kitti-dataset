...
model_id = "Frustum-PointNet_2"

num_epochs = 100
batch_size = 16
learning_rate = 0.001

network = FrustumPointNet(model_id, project_dir="/home/vrushabhdesai07//3DOD_thesis")
network = network.cuda()

NH = network.BboxNet_network.NH

train_dataset = DatasetFrustumPointNetAugmentation(kitti_data_path="/home/vrushabhdesai07/3DOD_thesis/data/kitti",
