...
network = FrustumPointNet("Frustum-PointNet_eval_val_seq", project_dir="/home/vrushabhdesai07/3DOD_thesis")
network.load_state_dict(torch.load("/home/vrushabhdesai07/3DOD_thesis/pretrained_models/model_37_2_epoch_400.pth"))
network = network.cuda()

NH = network.BboxNet_network.NH

val_dataset = EvalSequenceDatasetFrustumPointNet(kitti_data_path="/home/vrushabhdesai07/3DOD_thesis/data/kitti",
